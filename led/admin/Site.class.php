...
class Site extends DB{
    ...
    public function insert($data){
        if(!empty($data) && is_array($data)){
            ...
            $query = "INSERT INTO ".$this->siteTbl." (".$columns.") VALUES (".$values.")";
    ...
    public function update($data, $conditions){
        if(!empty($data) && is_array($data) && !empty($conditions)){
            ...
            //prepare sql query
            $query = "UPDATE ".$this->siteTbl." SET ".$cols_vals." WHERE ".$whereSql;
    ...
    public function delete($conditions){
        ...
        $query = "DELETE FROM ".$this->siteTbl.$whereSql;
